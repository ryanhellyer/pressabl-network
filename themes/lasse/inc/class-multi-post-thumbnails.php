 ...
 *
 * Adapted from the "Multiple Post Thumbnails" plugin by Chris Scott (http://vocecommuncations.com/)
 * Copyright 2010 Chris Scott (cscott@voceconnect.com)
 *
 * The URL to the javascript file was changed for use in the Lasse Super theme
 */
	...
	class MultiPostThumbnails {
		...
		public function enqueue_admin_scripts() {
			wp_enqueue_script(
				...
				get_template_directory_uri() . '/scripts/multi-post-thumbnails-admin.js',
				array('jquery'));
		}
