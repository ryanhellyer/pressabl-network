...
class batcache {
	...
	var $max_age =  1200; // Expire batcache items aged this many seconds (zero to disable batcache)
	
	var $remote  =    0; // Zero disables sending buffers to remote datacenters (req/sec is never sent)
	
	var $times   =    4; // Only batcache a page after it is accessed this many times... (two or more)
